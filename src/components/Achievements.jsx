...
function Achievements() {
  return (
    <div class='container' className='w-fit min-h-screen mx-6 lg:mx-48 my-10 '>
        ...
        <div className='flex flex-col lg:flex-row  lg:justify-evenly my-5'>
        <div className='md:w-[40%]  rounded-md border-[1px] border-gray-300 mx-2 flex flex-col-reverse mb-4 md:mb-0'>
...
<h1 className='text-4xl text-center text-slate-600'>
    ...
    <div className='md:w-[40%]  rounded-md border-[1px] border-gray-300 mx-2 flex flex-col-reverse'>
        <div className='flex flex-col items-center  p-2'>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 text-red-600">
  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6L9 12.75l4.286-4.286a11.948 11.948 0 014.306 6.43l.776 2.898m0 0l3.182-5.511m-3.182 5.51l-5.511-3.181" />
</svg>
<h1 className='text-4xl text-center text-slate-600'>
        ...
        <div className='md:w-[50%] p-2'>
                <p className='text-md lg:text-lg xl:text-xl lg:text-center font-light text-slate-600'>

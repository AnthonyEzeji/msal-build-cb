...
setClusterArray(tempArr)
  ...
  return (
    <div className='relative '>
        ...
        {!showLossRun&&!isLoading?<label for = 'file-picker' className="mt-8 inline-flex w-full items-center justify-center rounded-md border-transparent bg-red-600 px-5 py-3 text-base font-medium text-white hover:bg-transparent hover:text-red-600 border-[1px] hover:border-red-600  absolute sm:left-[35%] 2xl:left-[33%] sm:w-auto left-0 ">Upload Loss Run<AiOutlineUpload className='mx-2'/></label>:isLoading?<div className='md:min-w-[480px]  h-[500px]  flex items-center justify-center'><div role="status">

  ...
  return (
    <div className="relative bg-gray-50">
      <Popover className="relative bg-gray-800 shadow">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 bg-gray-800">
                  ...
                  <>
                    <Popover.Button
                      className={classNames(
                        ...
                        'group inline-flex items-center rounded-md bg-gray-800 text-base font-medium hover:text-red focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'
                      )}
                    >
                      <span>Solutions</span>
                      <ChevronDownIcon
      ...
      <main className="lg:relative">
        <div className="mx-auto w-full max-w-7xl pt-16 pb-20 text-center lg:py-48 lg:text-left">
          <div className="px-4 sm:px-8 lg:w-1/2 xl:pr-16">
            <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl md:text-3xl lg:text-3xl xl:text-3xl">

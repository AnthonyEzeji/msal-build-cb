...
function Tabs() {
  ...
  return (
    ...
    <Tab.List className={' w-fit flex justify-evenly p-0 bg-gray-100'}>
      <Tab><h1 className = {selectedIndex===0?'font-black md:text-3xl text-2xl text-indigo-700 m-5 ':'font-black md:text-3xl text-2xl text-indigo-300 m-5  '}>Hospitals</h1></Tab>
      <Tab><h1  className = {selectedIndex===1?'font-black md:text-3xl text-2xl text-indigo-700  m-5 ':'font-black md:text-3xl text-2xl text-indigo-300 m-5 '}>Physicians</h1></Tab>
 ...
 <h1 className='text-indigo-500 text-3xl px-2 py-4 font-semibold w-fit'>
        Risk Transfer
      </h1>

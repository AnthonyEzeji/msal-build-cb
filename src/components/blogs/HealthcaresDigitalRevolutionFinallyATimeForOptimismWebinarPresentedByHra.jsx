import BlogImg from '../../assets/blog images/HealthcaresDigitalRevolutionFinallyATimeForOptimismWebinarPresentedByHra.jpeg';
import Navbar from '../Navbar'
import Footer from '../Footer'

export default function HealthcaresDigitalRevolutionFinallyATimeForOptimismWebinarPresentedByHra() {
    return (
   ...
   <div className="relative px-6 lg:px-8">
     ...
     A Revolution in its Infancy
       ...
       <ul role="list">
            <li>1. Digitizing the record
              <p className="mt-8 text-xl leading-8 text-gray-500">This is about the basic move from paper to digital, which has been generally accomplished by the rise of the EHR. 
                </p> </li>
            <li>2. Connecting the parts 
            <p className="mt-8 text-xl leading-8 text-gray-500">This stage is about connecting primary care physicians to hospitals, connecting hospitals to other hospitals and so on. But it’s also about connecting third-party and patient-facing apps to healthcare providers and systems. This is the stage we are in right now. 
                </p>
            </li>
            <li>3. Gleaning meaningful insights from data 
            <p className="mt-8 text-xl leading-8 text-gray-500">All this digitizing means it’s easier than ever to collect data. But collecting data is not enough. We need to find ways to synthesize the data and pull meaningful information from it.  
                </p>
            </li>
            <li>4. Converting insights into action 
            <p className="mt-8 text-xl leading-8 text-gray-500">They say knowledge is power. But without action, knowledge is impotent. We must take the meaningful insights we glean and turn them into action that improves patient care and our healthcare system.  
                </p>
            </li>
          </ul>
       </p>
     ...
     <div className="w-1/2 prose-lg prose-red mx-auto mt-6 text-gray-500">
     <p className="mt-8 text-lg leading-8 text-gray-500 italic"><a class='text-red-600 underline' href='https://www.healthcareriskadvisors.com/about/leadership/david-l.-feldman/'>David L. Feldman</a>, MD, MBA, CPE, FAAPL, FACS, is an experienced healthcare leader, serving for many years as chief medical officer (CMO) of the HIC/FOJP hospitals in New York City. In addition to serving as chief medical officer of The Doctors Company and TDC Group, he is senior vice president and chief medical officer at HRA, a TDC Group company. Under Dr. Feldman’s leadership, HRA provides resources and a collaborative environment designed to minimize claims and lower premiums for HRA clients by preventing patient harm, enhancing teamwork and communication, and improving documentation. </p>

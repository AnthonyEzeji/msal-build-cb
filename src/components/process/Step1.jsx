...
export default function Example() {
    return (
      <div className=" flex flex-col-reverse md:flex-row w-full justify-center  items-center pt-16 pb-80">
        ...
        <div className=" max-w-2xl py-16 px-6 text-center sm:py-20 lg:px-8 ">
          <h2 className="text-3xl font-bold tracking-tight text-slate-700 sm:text-4xl">
            ...
            <span className="block text-red-600 text-3xl">Transforming Healthcare One Patient at a Time.</span>
          </h2>
          <p className="mt-4 text-xl leading-2 underlined prose text-zinc-700 px-6  drop-shadow-lg ">

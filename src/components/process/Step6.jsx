...
export default function Example() {
    return (
      <div className=" flex flex-col  w-full justify-center items-center py-32">
        ...
        <div className=" max-w-2xl py-10 px-6 text-center sm:py-10 lg:px-8 ">
          <h2 className="text-3xl font-bold tracking-tight text-slate-700 sm:text-4xl">
            ...
            <span className="block text-red-600 text-xl">Devise a Data Driven Litigation Strategy</span>
          </h2>
